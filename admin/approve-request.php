...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($request) {
        ...
        $stmt = $pdo->prepare("INSERT INTO roomregistration (user_id, event_id, room_id, start_time, end_time, status) VALUES (:user_id, :event_id, :room_id, :start_time, :end_time, 'approved')");
        $stmt->bindParam(':user_id', $userId, PDO::PARAM_INT);
        ...
        $message = "Dear user,<br><br>Your room reservation request has been approved by the admin.<br><br>Reservation Details:<br>Event ID: $eventId<br>Room ID: $roomId<br>Start Time: $startTime<br>End Time: $endTime<br><br>Thank you.";
